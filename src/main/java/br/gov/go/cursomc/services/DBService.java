...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException{
		...
		Cliente cli1 = new Cliente(null, "Weverson Luiz", "weversonluiz@hotmail.com", "36378912377", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Heitor Rodrigues", "weverson408@gmail.com", "34876578800", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123"));
