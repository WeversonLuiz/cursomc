...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException{
		...
		Cliente cli1 = new Cliente(null, "Weverson Luiz", "weversonluiz@hotmail.com", "36378912377", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Heitor Rodrigues", "weverson408@gmail.com", "34876578800", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("32545252", "21452536"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida São João", "310", "Qd.02", "Vila Maria", "38777012", cli2, c2);
